...
const Navigation = ({ currentUser }: IPropsNavigation) => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 border-b h-[60px] dark:border-gray-600 gap-2 p-2 font-semibold dark:bg-gray-900 bg-slate-50 z-30 flex items-center">
      <Logo />
