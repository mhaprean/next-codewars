  ...
  return (
    <>
      {difficulty.toLowerCase() === 'easy' && (
        <span className="bg-green-500/30 rounded-full px-3 py-1 text-green-600 dark:text-green-400">Easy</span>
      )}
      ...
      {difficulty.toLowerCase() === 'hard' && (
        <span className="bg-red-500/30 rounded-full px-3 py-1 text-red-600 dark:text-red-400">Hard</span>
      )}
    </>
  );
};
